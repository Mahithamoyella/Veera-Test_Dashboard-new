...
app.get('/', (req, res) => {
  res.sendFile(path.join(__dirname, 'http://54.209.86.85:8121/Login/index.html'));
});

app.get('/signup', (req, res) => {
  res.sendFile(path.join(__dirname, 'http://54.209.86.85:8122/Sign_up/index.html'));
});

app.get('/forgot-password', (req, res) => {
  res.sendFile(path.join(__dirname, 'http://54.209.86.85:8120/Forgot/index.html'));
});

app.get('/dashboard', authenticateToken, (req, res) => {
  const filePath = path.join(__dirname, 'http://54.209.86.85:8119/Dashboard/dashboard.html');
...
res.cookie('token', token, {
  ...
  maxAge: 60 * 60 * 1000,
  domain: process.env.NODE_ENV === 'production' ? 'yourdomain.com' : '54.209.86.85'
});
